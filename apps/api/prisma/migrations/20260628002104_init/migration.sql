...
-- CreateEnum
CREATE TYPE "SaleType" AS ENUM ('CASH', 'TERM', 'INSTALLMENT');

-- CreateEnum
CREATE TYPE "CashStatus" AS ENUM ('OPEN', 'CLOSED');

-- CreateEnum
CREATE TYPE "CashMovementType" AS ENUM ('OPENING', 'SALE', 'WITHDRAWAL', 'SUPPLY', 'CLOSING');

-- CreateEnum
CREATE TYPE "PayableStatus" AS ENUM ('OPEN', 'PARTIAL', 'PAID', 'CANCELED');

-- CreateEnum
CREATE TYPE "ReceivableStatus" AS ENUM ('OPEN', 'PARTIAL', 'PAID', 'OVERDUE', 'CANCELED');

-- CreateEnum
CREATE TYPE "InstallmentStatus" AS ENUM ('OPEN', 'PAID', 'OVERDUE', 'RENEGOTIATED', 'CANCELED');

-- CreateEnum
CREATE TYPE "CreditStatus" AS ENUM ('ACTIVE', 'BLOCKED');

-- CreateEnum
CREATE TYPE "CollectionChannel" AS ENUM ('WHATSAPP', 'SMS', 'EMAIL', 'MANUAL');

-- CreateEnum
CREATE TYPE "CollectionStatus" AS ENUM ('PENDING', 'SENT', 'FAILED');
